...
address, path = get_btc_address(client,"SPENDP2SHWITNESS",show_disp=False)
print(path, "bitcoin SPENDP2SHWITNESS address:", address) # SPENDP2SHWITNESS: 1/16Mk...
print("-"*50)

address, path = get_btc_address(client,"SPENDWITNESS",show_disp=False)
print(path, "bitcoin SPENDWITNESS address:", address) # SPENDWITNESS: 1/16Mk...
print("-"*50)

address, path = get_btc_address(client,"SPENDTAPROOT",show_disp=False)
