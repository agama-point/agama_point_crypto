        ...
        if self.image:
            ...
            for i in range(h):
                for j in range(w):
                    ...
                    # Převod na běžné celočíselné číslo pro podporu záporných hodnot
                    new_value = int(current_color[channel_idx]) + offset
                    # Ujistíme se, že hodnota zůstane v rozsahu 0-255
                    current_color[channel_idx] = np.clip(new_value, 0, 255)
